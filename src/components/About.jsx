...
const About = () => {
  return (
    <section id="about" className="py-20 border-b border-slate-200 dark:border-slate-800 transition-colors duration-300">
      <motion.h2
      ...
      <motion.div
        ...
        className="max-w-4xl mx-auto text-center text-slate-600 dark:text-slate-300 leading-relaxed"
      >
        <p className="mb-4">
          Hi, I'm <span className="text-cyan-600 dark:text-cyan-400 font-semibold">Peheliya Dhanuka Navod</span>, 
