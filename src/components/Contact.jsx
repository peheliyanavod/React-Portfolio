...
const Contact = () => {
  return (
    <div id="contact" className="border-b border-neutral-900 pb-20 mx-20">
      ...
      className="my-10 text-center text-5xl">Get in Touch</motion.h1>
      <div className="text-center tracking-tighter items-center mx-auto">
      <motion.p
        whileInView={{opacity: 1, x:0}}
        initial={{opacity:0, x:-100}}
        transition={{duration:1}} className="my-4">076-4447198</motion.p>
        <motion.p
        whileInView={{opacity: 1, x:0}}
        initial={{opacity:0, x:100}}
        transition={{duration:1}} className="my-4">Jayamini, Dehigahalanda, Ambalantota</motion.p>
        <motion.p
        whileInView={{opacity: 1, x:0}}
        initial={{opacity:0, x:-100}}
        transition={{duration:1}} className="my-4">hwpeheliya@gmail.com</motion.p>
        <motion.div
        whileInView={{opacity: 1, x:0}}
        initial={{opacity:0, x:100}}
